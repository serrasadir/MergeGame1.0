Try to use a hybrid pooling system to get the most efficient results - though have some misused functions that i will never use again i.e get all children functions
